...
public:
	...
	thBool setPlayerMoveTo(enum THEM_CHARARCTERLEVEL_MOVESPEED emSpeed, enum THEM_CHARACTERFSM_STATUS emDirection, CThPlayer* pPlayer) noexcept;
